package net.runelite.client.plugins.microbot.maggot;
...
@PluginDescriptor(
        name = PluginDescriptor.Default + "Little Bitch Boy",
        description = "Performance test for bitch boy retrievals",
...
public class MaggotScript {
    ...
    public static void examples() {
        ...
        Rs2NpcModel goblin = cache.query().withName("Karim").nearest();
        if ((goblin) != null) {
            goblin.click("Talk-to");
        }
